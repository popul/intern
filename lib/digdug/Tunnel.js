...
define([
	...
	Tunnel.prototype = util.mixin(Object.create(_super), {
		...
		/**
		 * Sends information about a session to the tunnel provider.
		 *
		 * @param {string} sessionId The session to send data about.
		 * @param {Object} data Data to send to the tunnel provider about the session.
		 */
		sendJobData: function () {
			// TODO: Write API
			var dfd = util.deferred();
			dfd.resolve();
			return dfd.promise;
